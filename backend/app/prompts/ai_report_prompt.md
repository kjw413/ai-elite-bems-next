...
- 운영 생산량은 `production_actual_service`에서 **DB_생산실적 완제품 + 판매용 반제품(WIP)**으로 만든다. 판매용 WIP는 **광주공장만** 합산하며, `DB_재공품.xlsx`의 7품목(`260014`, `260016`, `260039`, `260042`, `260047`, `260351`, `260352`)에 품목별 환산계수를 적용한다.
