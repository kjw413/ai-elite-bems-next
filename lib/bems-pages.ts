import { BarChart3, Bolt, BrainCircuit, FileText, Gauge, PackageCheck, Settings, TrendingDown, type LucideIcon } from "lucide-react";
...
export type PageId = "dashboard" | "energy" | "intensity" | "production" | "savings" | "prediction" | "report" | "admin";
...
export const PAGE_DEFS: { id: PageId; label: string; icon: LucideIcon }[] = [
  ...
  { id: "savings", label: "에너지 절감", icon: TrendingDown },
