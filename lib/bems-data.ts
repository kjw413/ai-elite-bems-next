...
// 2026-07-19 dataviz 검증 재보정: 색상 계열(정체성)은 유지하고 명도 단계만 이동해
// 5색 전 쌍(all-pairs) 정상시각 ΔE≥15(하드 게이트)를 통과시켰다 — 김해 주황→앰버,
// 광주 녹색 한 단계 진하게, 논산 적색 진하게, 경산 틸→시안(녹색과 CVD 분리).
// 라이트(#fff)·다크(#131c17) 표면 모두 검증 통과. CVD 최악쌍 6.2(광주↔김해)는
// 6–8 허용 밴드 — 도넛 % 직접 라벨·범례·상세 테이블(부차 인코딩)로 커버한다.
export const factoryColors: Record<string, string> = {
  전사: "#3b82f6", 남양주: "#8b5cf6", 남양주1: "#a855f7", 남양주2: "#7c3aed",
  김해: "#d97706", 광주: "#16a34a", 논산: "#b91c1c", 경산: "#0891b2",
};
